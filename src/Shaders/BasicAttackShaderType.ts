...
export default class BubbleShaderType extends RectShaderType {
	...
	public static KEY: string = "BASICATTACK_SHADER_TYPE_KEY";
	public static VSHADER: string = "assets/shaders/basicAttack.vshader";
	public static FSHADER: string = "assets/shaders/basicAttack.fshader";
